...
| SFace  | [opencv/opencv_zoo](https://github.com/opencv/opencv_zoo/tree/master/models/face_recognition_sface) | Apache-2.0 | Detectorに顔検出を指定してください<br>※推論前に顔の角度を垂直にする処理をすべきだが、本フレームワークでは未対応 |
